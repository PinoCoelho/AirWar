...
public class ListaEnlazada {
     ...
     */
    class Node {
        private Map.Building data; // el data de los nodos es un array
        private Node next; // next es el siguiente nodo

        public Node(Map.Building data) {
            this.next = null;
            this.data = data;
        }
         ...
         * @param data un array
         */
        public void setData(Map.Building data) {
            this.data = data;
        }
     ...
     * @param data un array
     */
    public void insertFirst(Map.Building data) {
     ...
     */
    public Map.Building deleteFirst() {
        if (this.head != null) {
            Node temp = this.head;
     ...
     */
    public Map.Building delete(int id) {
     ...
     * @param data
     */
    public void insertLast(Map.Building data)
    {
        Node newNode = new Node(data);
        Node temp = this.head;
        if (this.head == null) {
     ...
     */
    public Map.Building get(int searchValue) {
        Node current = this.head;
        int counter = 0;
        while (current != null) {
